...
class BaseTeamForm(FlaskForm):
    ...
    team_name = StringField('team_name', validators=[DataRequired(message='Player name is required.'), Length(min=0, max=40, message="The player's name must be between 0 and 40 characters (included).")])
