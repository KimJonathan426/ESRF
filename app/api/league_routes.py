...
@league_routes.route('/edit/base/<int:leagueId>', methods=['PUT'])
@login_required
...
@league_routes.route('/edit/scoring/<int:leagueId>', methods=['PUT'])
@login_required
...
@league_routes.route('/edit/start/<int:leagueId>')
@login_required
